...
CRITICAL GROUNDING RULE: Answer ONLY using the facts literally present in the RETRIEVED PASSAGES. Do NOT invent, make up, or hallucinate any story narrative, plot points, events, or character details that are not explicitly written. If the retrieved passage is extremely short or contains only a heading, title, or page number (such as "ಹೇಳಿ ಹೋಗು ಕಾರಣ / 05"), you MUST state clearly and literally that the page contains only that heading, and list exactly what is written. Do NOT extrapolate or assume any story events.
Answer in English and cite page numbers when referencing passages.
...
ಪ್ರಮುಖ ಗ್ರೌಂಡಿಂಗ್ ನಿಯಮ (CRITICAL GROUNDING RULE): ಹಿಂಪಡೆದ ಪಠ್ಯದಲ್ಲಿ (RETRIEVED PASSAGES) ನೇರವಾಗಿ ಇರುವ ವಿಷಯಗಳನ್ನು ಮಾತ್ರ ಆಧರಿಸಿ ಉತ್ತರಿಸಿ. ನಿಮ್ಮ ಸ್ವಂತ ಕಲ್ಪನೆ ಅಥವಾ ಕಥೆಯನ್ನು ಸೇರಿಸಬೇಡಿ. ಹಿಂಪಡೆದ ಭಾಗದಲ್ಲಿ ಕೇವಲ ಶೀರ್ಷಿಕೆ ಅಥವಾ ಪುಟದ ಸಂಖ್ಯೆ ಇದ್ದರೆ (ಉದಾಹರಣೆಗೆ 'ಹೇಳಿ ಹೋಗು ಕಾರಣ / 05'), ಆ ಪುಟದಲ್ಲಿ ಕೇವಲ ಅದೇ ಶೀರ್ಷಿಕೆ ಇದೆ ಎಂದು ಸ್ಪಷ್ಟವಾಗಿ ತಿಳಿಸಿ. ಕಥೆಯ ವಿಷಯಗಳನ್ನು ಊಹಿಸಬೇಡಿ.
...
CRITICAL GROUNDING RULE: Summarize ONLY the provided text. Do NOT invent, make up, or hallucinate any story narrative, plot points, events, or character details. If the text is extremely short or contains only a heading, title, or page number (such as "ಹೇಳಿ ಹೋಗು ಕಾರಣ / 05"), you MUST state clearly and literally that the page contains only that heading, and list exactly what is written. Do NOT extrapolate or guess what happens in the chapter.

Do not say "I don't have access" or "The page is unavailable" if there is text present, but if the page is empty, state so.
...
ಪ್ರಮುಖ ಗ್ರೌಂಡಿಂಗ್ ನಿಯಮ (CRITICAL GROUNDING RULE): ಒದಗಿಸಿದ ಪಠ್ಯವನ್ನು ಮಾತ್ರ ಸಾರಾಂಶ ಮಾಡಿ. ಉತ್ತರದಲ್ಲಿ ಯಾವುದೇ ಕಲ್ಪಿತ ಕಥೆ ಅಥವಾ ಮಾಹಿತಿಯನ್ನು ಸೇರಿಸಬೇಡಿ. ಪುಟದ ವಿಷಯವು ಕೇವಲ ಶೀರ್ಷಿಕೆ ಅಥವಾ ಪುಟದ ಸಂಖ್ಯೆಯಾಗಿದ್ದರೆ (ಉದಾಹರಣೆಗೆ 'ಹೇಳಿ ಹೋಗು ಕಾರಣ / 05'), ಆ ಪುಟದಲ್ಲಿ ಕೇವಲ ಅದೇ ಶೀರ್ಷಿಕೆ ಇದೆ ಎಂದು ಸ್ಪಷ್ಟವಾಗಿ ತಿಳಿಸಿ.
