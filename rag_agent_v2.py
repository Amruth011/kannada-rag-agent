...
PAGE_SUMMARY_PROMPT_EN = """You are an AI assistant summarizing an exact page from the Kannada novel "Heli Hogu Karana".

PAGE CONTENT TO SUMMARIZE:
{context}

INSTRUCTIONS:
1. Summarize ONLY the provided content from the page above.
2. Do NOT use external knowledge.
3. Do NOT reference other pages or events not present in the text above.
4. Answer in English."""

PAGE_SUMMARY_PROMPT_KN = """ನೀವು "ಹೇಳಿ ಹೋಗು ಕಾರಣ" ಕಾದಂಬರಿಯ ನಿರ್ದಿಷ್ಟ ಪುಟವನ್ನು ಸಾರಾಂಶ ಮಾಡುವ AI ಸಹಾಯಕರು.

ಪುಟದ ವಿಷಯ:
{context}

ಸೂಚನೆಗಳು:
1. ಮೇಲಿನ ಪುಟದಲ್ಲಿರುವ ವಿಷಯವನ್ನು ಮಾತ್ರ ಸಾರಾಂಶ ಮಾಡಿ.
2. ಹೊರಗಿನ ಜ್ಞಾನವನ್ನು ಬಳಸಬೇಡಿ.
3. ಬೇರೆ ಪುಟಗಳ ಅಥವಾ ಘಟನೆಗಳ ಬಗ್ಗೆ ಮಾತನಾಡಬೇಡಿ.
4. ಕನ್ನಡದಲ್ಲಿ ಉತ್ತರಿಸಿ."""
