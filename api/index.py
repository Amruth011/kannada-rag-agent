...
async def root():
    ...
    <head>
        ...
        <style>
            ...
            .nav-github-btn:hover svg {
                transform: scale(1.15);
            }
            body.dark-mode .nav-github-btn {
                background: rgba(255, 255, 255, 0.06);
                border-color: rgba(255, 255, 255, 0.15);
                color: #e2e8f0;
            }
            body.dark-mode .nav-github-btn:hover {
    ...
    <body>
        ...
        <header class="nav-header">
            <div class="nav-container" style="display: flex; justify-content: space-between; align-items: center; width: 100%;">
                ...
                <div style="display: flex; align-items: center; gap: 6px;">
                    <a href="https://github.com/Amruth011/kannada-rag-agent" target="_blank" rel="noopener noreferrer" class="nav-github-btn" title="Star on GitHub">
                        <svg height="14" width="14" viewBox="0 0 16 16"><path d="M8 0C3.58 0 0 3.58 0 8c0 3.54 2.29 6.53 5.47 7.59.4.07.55-.17.55-.38 0-.19-.01-.82-.01-1.49-2.01.37-2.53-.49-2.69-.94-.09-.23-.48-.94-.82-1.13-.28-.15-.68-.52-.01-.53.63-.01 1.08.58 1.23.82.72 1.21 1.87.87 2.33.66.07-.52.28-.87.51-1.07-1.78-.2-3.64-.89-3.64-3.95 0-.87.31-1.59.82-2.15-.08-.2-.36-1.02.08-2.12 0 0 .67-.21 2.2.82.64-.18 1.32-.27 2-.27.68 0 1.36.09 2 .27 1.53-1.04 2.2-.82 2.2-.82.44 1.1.16 1.92.08 2.12.51.56.82 1.27.82 2.15 0 3.07-1.87 3.75-3.65 3.95.29.25.54.73.54 1.48 0 1.07-.01 1.93-.01 2.2 0 .21.15.46.55.38A8.013 8.013 0 0016 8c0-4.42-3.58-8-8-8z"/></svg>
                        <span>⭐ Star</span>
                    </a>
        ...
        <!-- FAQ SECTION AS A SEPARATE CARD (Visible only in AI Guide tab) -->
        <div class="container fade-in" id="faq-section-container" style="margin-top: 2.2rem; display: block; animation-delay: 0.25s;">
            <div class="card faq-accordion-section" style="padding: 2.2rem 2rem; position: relative;">
                <style>
                    .faq-badge {
                        display: inline-flex;
                        align-items: center;
                ...
                <div style="text-align: center; margin-bottom: 2.2rem; position: relative;">
                    ...
                    <svg class="faq-doodles" width="120" height="90" viewBox="0 0 120 90" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round" style="position: absolute; right: 20px; top: -15px; color: var(--text-muted); opacity: 0.25; pointer-events: none;">
                        ...
                        <path d="M18 35 C15 38, 12 40, 10 40 C14 43, 16 46, 18 48" />
                        ...
                        <path d="M75 28 C74 32, 70 35, 68 38 C72 38, 74 37, 76 36" />
                ...
                <div class="faq-container">
                    ...
                    <details class="faq-item">
                        ...
                        <div class="faq-answer">
                            ...
                            <br><br>
                            <span style="color: var(--primary); font-style: italic; font-size: 0.88rem;">ಹೌದು! ಕಾದಂಬರಿಯ ಕನ್ನಡ ಆವೃತ್ತಿ, ಇಂಗ್ಲಿಷ್ ಅನುವಾದ ಮತ್ತು ದ್ವಿಭಾಷಾ ಇ-ಪುಸ್ತಕಗಳನ್ನು ನೀವು ಆನ್‌ಲೈನ್‌ನಲ್ಲಿ ಓದಬಹುದು ಅಥವಾ ಆಫ್‌ಲೈನ್‌ನಲ್ಲಿ ಓದಲು ಉಚಿತವಾಗಿ ದೌನ್‌ಲೋಡ್ ಮಾಡಿಕೊಳ್ಳಬಹುದು.</span>
                        </div>
                    </details>
        ...
        <script>
            function switchTab(tabId) {
                ...
                // Control FAQ card visibility (only visible on 'chat' tab)
                const faqCard = document.getElementById('faq-section-container');
                if (faqCard) {
                    faqCard.style.display = (tabId === 'chat') ? 'block' : 'none';
                }
